    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8">Logo & Identity</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Primary Logo */}
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              <div className="bg-gray-900 rounded-lg p-6 mb-4 flex items-center justify-center">
                <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
                  <circle cx="60" cy="60" r="58" fill="#8B5CF6" fillOpacity="0.1" stroke="#8B5CF6" strokeWidth="2"/>
                  <path d="M60 25L75 45L45 45Z" fill="#8B5CF6"/>
                  <path d="M50 50L70 50L70 70L50 70Z" fill="#A78BFA" fillOpacity="0.8"/>
                  <path d="M45 75L75 75L65 95L55 95Z" fill="#7C3AED"/>
                  <circle cx="60" cy="60" r="4" fill="#FFFFFF"/>
                </svg>
              </div>
              <h3 className="text-white font-semibold mb-2">Primary Logo</h3>
              <p className="text-gray-400 text-sm mb-4">Main brand mark for all uses</p>
            ...
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              <div className="bg-white rounded-lg p-6 mb-4 flex items-center justify-center">
                <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
                  ...
                  <path d="M40 65H80V85H40V65Z" fill="white" fillOpacity="0.8"/>
                  <circle cx="60" cy="75" r="6" fill="#8B5CF6"/>
                </svg>
              </div>
              <h3 className="text-white font-semibold mb-2">App Icon</h3>
              <p className="text-gray-400 text-sm mb-4">For app stores and favicons</p>
              <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-lg transition-colors">
                <Download className="w-4 h-4 inline mr-2" />
                Download PNG
              </button>
            ...
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              <div className="bg-gray-900 rounded-lg p-6 mb-4 flex items-center justify-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-2xl font-bold text-white">FarDrops</span>
                </div>
              </div>
              <h3 className="text-white font-semibold mb-2">Wordmark</h3>
              <p className="text-gray-400 text-sm mb-4">Logo with text for headers</p>
              <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-lg transition-colors">
                <Download className="w-4 h-4 inline mr-2" />
                Download SVG
              </button>
        ...
        <section className="mb-16">
          ...
          {/* Secondary Colors */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-white mb-4">Secondary Colors</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Neutral Colors */}
          <div>
            <h3 className="text-xl font-semibold text-white mb-4">Neutral Colors</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
            <div className="space-y-6">
              <div>
                ...
                <h1 className="text-5xl font-bold text-white">Never Miss a Drop</h1>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-2">Heading 1</p>
                <h1 className="text-4xl font-bold text-white">Track Every Airdrop</h1>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-2">Heading 2</p>
                <h2 className="text-3xl font-semibold text-white">Farcaster Native</h2>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-2">Body Large</p>
                <p className="text-lg text-gray-300">The first and only airdrop tracker built specifically for the Farcaster ecosystem.</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-2">Body</p>
                <p className="text-base text-gray-300">Monitor DEGEN, Clanker tokens, NFT drops, and Power Badge exclusives all in one place.</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-2">Caption</p>
                <p className="text-sm text-gray-400">Real-time notifications • Eligibility checking • Multi-chain support</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Brand Voice */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8">Brand Voice & Messaging</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              <h3 className="text-xl font-semibold text-white mb-4">Our Voice</h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>
                  <span><strong>Knowledgeable:</strong> We know the Farcaster ecosystem inside out</span>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>
                  <span><strong>Helpful:</strong> We're here to make sure you never miss opportunities</span>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>
                  <span><strong>Timely:</strong> Speed matters in crypto - we deliver instant alerts</span>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>
                  <span><strong>Trustworthy:</strong> Accurate information, no hype, just facts</span>
                </li>
              </ul>
            </div>

            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              <h3 className="text-xl font-semibold text-white mb-4">Key Messages</h3>
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-purple-400 font-semibold mb-1">Value Prop</p>
                  <p className="text-white">"The first dedicated airdrop tracker for Farcaster"</p>
                </div>
                <div>
                  <p className="text-purple-400 font-semibold mb-1">Mission</p>
                  <p className="text-white">"Democratizing airdrop access for the Farcaster community"</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Usage Guidelines */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8">Usage Guidelines</h2>
          <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-green-500 mb-4">✓ Do's</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-red-500 mb-4">✗ Don'ts</h3>
                <ul className="space-y-2 text-gray-300">
        ...
        <section>
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Download Complete Brand Kit</h2>
